...
echo ""
echo "Optional: Enable speaker diarization"
echo "  Export PYANNOTE_AUTH_TOKEN before running docker-compose to label speakers."
echo "  Example: export PYANNOTE_AUTH_TOKEN=your_huggingface_token"
echo ""
echo "To view logs:"
